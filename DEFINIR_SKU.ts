function main(workbook: ExcelScript.Workbook) {
    ...
    let ultimaLinhaInicial = w_inputInicial.getCell(w_inputInicial.getRange().getRowCount() - 1, 10)
    ...
    let rangeLimpar = w_instore.getRange("A1:L1");
    rangeLimpar.clear();
    let rangeLimpar2 = w_online.getRange("A1:L40");
    rangeLimpar2.clear();
